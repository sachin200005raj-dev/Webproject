...
const DeleteAccount = () => {
  ...
  return (
    <section className="flex justify-center items-center h-[calc(100vh-70px)] w-[100%] bg-slate-900 ">
      <div className="w-[30%] bg-black p-4 rounded-lg">
        <header>
          <h1 className="text-center text-white text-2xl ">Delete Account</h1>
        </header>
        <main className="p-2 ">
          <form
            action=""
          ...
          >
            <div>
              <h3 className="text-white">Are You Sure Want to Delete the Account?</h3>
              <h3 className="text-white">If yes , Enter Delete Account</h3>
              <input
                type="text"
                placeholder="Delete Account"
                className="outline-none bg-white py-2 px-4 rounded-lg text-black mt-2 w-[100%]"
                name="text"
                value={text}
